...
Welcome to ``makfit-core`` contributor's guide.
...
If you experience bugs or general issues with ``makfit-core``, please have a look
...
You can help improve ``makfit-core`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``makfit-core`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``makfit-core``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n makfit-core python=3 six virtualenv pytest pytest-cov
    conda activate makfit-core
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/makfit-core.git
    cd makfit-core
...
#. Install |pre-commit|_::
   ...
   ``makfit-core`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/makfit-core
.. _issue tracker: https://github.com/<USERNAME>/makfit-core/issues
.. <-- end -->
